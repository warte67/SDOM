...
namespace SDOM
{
    bool Core_UnitTests()
    {
        ...
        testResult = UnitTests::run("Core", "Window Height", [&core, &expected]() {
            int actualW = 0, actualH = 0;
            SDL_GetWindowSize(core.getWindow(), &actualW, &actualH);
        ...
        testResult = UnitTests::run("Core", "Pixel Width", [&core, &expected]() {
        ...
        testResult = UnitTests::run("Core", "Pixel Height", [&core, &expected]() {
        ...
        testResult = UnitTests::run("Core", "Preserve Aspect Ratio", [&core, &expected]() {
        ...
        testResult = UnitTests::run("Core", "Allow Texture Resize", [&core, &expected]() {
        ...
        testResult = UnitTests::run("Core", "Pixel Format", [&core, &expected]() {
        ...
        testResult = UnitTests::run("Core", "Renderer Logical Presentation", [&core, &expected]() {
        ...
        testResult = UnitTests::run("Core", "Window Flags", [&core, &expected]() {
        ...
        // Config_Test: Color
        testResult = UnitTests::run("Core", "Border Color", [&core, &expected]() {
