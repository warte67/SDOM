...
namespace SDOM
{
    ...
    protected:
        ...
        virtual void _registerLua_Meta(sol::state_view lua)  override       { SUPER::_registerLua_Meta(lua); }
        virtual void _registerLua_Children(sol::state_view lua) override    { SUPER::_registerLua_Children(lua); }
